...
q2 = Question('Государственный язык в Бразилии', 'Португальский', 'Французкий', 'Английский', 'Немецкий')
q3 = Question('Как звали последнего российского императора?', 'Николай II', 'Александр III', 'Б. Ельцин', 'И. Сталин')
q4 = Question('Когда налась Великая Отечественная война?', '1941', '1945', '1930', '1943')
